...
public class NewJFrame1 extends javax.swing.JFrame {
    ...
    public NewJFrame1(model.User loggedUser, model.Patient viewedPatient) {
        initComponents();
        this.user = loggedUser;
        this.patient = viewedPatient;
        this.setBackground(new Color(0, 0, 0, 0));
        this.setLocationRelativeTo(null);
        jButton7.setVisible(loggedUser instanceof model.Administrator);
        loadDoctorComboBox();
    ...
    private void jRadioButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton4ActionPerformed
        ...
        jComboBox5.addItem("Select one");
        for (model.Doctor d : store.getDoctors()) {
            jComboBox5.addItem(String.valueOf(d.getId()));
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        Response response = ctrl.request(patient, byDoctor, selected,
            jTextField12.getText(), jTextField13.getText(), jTextArea4.getText(), type);
        if (response.isSuccess()) {
            JOptionPane.showMessageDialog(this, response.getMessage(), "Success", JOptionPane.INFORMATION_MESSAGE);
            jTextField12.setText(""); jTextField13.setText(""); jTextArea4.setText("");
            jComboBox5.setSelectedIndex(0); jComboBox1.setSelectedIndex(0);
            loadAppointmentComboBox();
        } else {
            JOptionPane.showMessageDialog(this, response.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        String doctorSelected = (String) jComboBox2.getSelectedItem();
        ...
        String roomSelected = (String) jComboBox3.getSelectedItem();
        ...
        Response response = ctrl.request(patient, Long.parseLong(doctorSelected),
            jTextField16.getText(), jTextArea3.getText(), roomSelected, jTextArea1.getText());
        if (response.isSuccess()) {
            JOptionPane.showMessageDialog(this, response.getMessage(), "Success", JOptionPane.INFORMATION_MESSAGE);
            jTextArea3.setText(""); jTextField16.setText(""); jTextArea1.setText("");

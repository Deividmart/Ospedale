...
public class NewJFrame111 extends javax.swing.JFrame {
    ...
    public NewJFrame111(model.User loggedUser, model.Doctor viewedDoctor) {
        initComponents();
        this.user = loggedUser;
        this.doctor = viewedDoctor;
        this.setBackground(new Color(0, 0, 0, 0));
        this.setLocationRelativeTo(null);
        jButton11.setVisible(loggedUser instanceof model.Administrator);
    ...
    private void loadAppointmentCombos() {
        jComboBox2.removeAllItems(); jComboBox2.addItem("Select one");
        jComboBox3.removeAllItems(); jComboBox3.addItem("Select one");
        jComboBox4.removeAllItems(); jComboBox4.addItem("Select one");
        jComboBox7.removeAllItems(); jComboBox7.addItem("Select one");
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        UpdateDoctorController ctrl = new UpdateDoctorController();
        ...
        if (response.isSuccess()) {
            ...
            jTextField1.setText(""); jTextField2.setText(""); jTextField6.setText("");
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        if (jRadioButton5.isSelected()) {
            ...
            CancelHospitalizationController ctrl = new CancelHospitalizationController();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        if (jRadioButton6.isSelected()) {
            ...
            AcceptHospitalizationController ctrl = new AcceptHospitalizationController();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        AcceptAppointmentController ctrl = new AcceptAppointmentController();
        Response response = ctrl.accept(doctor, selected);
        if (response.isSuccess()) {
            JOptionPane.showMessageDialog(this, response.getMessage(), "Success", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        CompleteAppointmentController ctrl = new CompleteAppointmentController();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        try {
            ...
            frequency = Integer.parseInt(jTextField27.getText().trim());
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Dose, duration, and frequency must be numbers", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        PrescribeMedicationController ctrl = new PrescribeMedicationController();
        Response response = ctrl.prescribe(doctor, selected, jTextField24.getText(),
            dose, jTextField26.getText(), treatmentDuration, jTextField29.getText(), frequency);
        if (response.isSuccess()) {
            JOptionPane.showMessageDialog(this, response.getMessage(), "Success", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        RescheduleAppointmentController ctrl = new RescheduleAppointmentController();
        Response response = ctrl.reschedule(doctor, selected, jTextField13.getText(), jTextField14.getText());
        if (response.isSuccess()) {
            JOptionPane.showMessageDialog(this, response.getMessage(), "Success", JOptionPane.INFORMATION_MESSAGE);
            jComboBox3.setSelectedIndex(0); jTextField13.setText(""); jTextField14.setText("");
        } else {
            JOptionPane.showMessageDialog(this, response.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }

...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Response response = loginCtrl.login(jTextField1.getText(), jTextField2.getText());
        if (response.isSuccess()) {
            ...
            switch (userType) {
                case "admin":
                    new NewJFrame11(loggedUser).setVisible(true);
                    break;
                case "doctor":
                    new NewJFrame111(loggedUser, (model.Doctor) loggedUser).setVisible(true);
                    break;
                default:
                    new NewJFrame1(loggedUser, (model.Patient) loggedUser).setVisible(true);
                    break;
            }
        } else {
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if (response.isSuccess()) {
            ...
            jTextField12.setText(""); jComboBox1.setSelectedIndex(0);
        } else {
            JOptionPane.showMessageDialog(this, response.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
